...
#define KP_CARET (ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_GRAVE_ACCENT_AND_TILDE))
...
CUSTOM_NUMBER(cn7, &kp N7, &kp LS(N6)) // LSHIFT + N6 = &
CUSTOM_NUMBER(cn8, &kp N8, &kp KP_STAR)
CUSTOM_NUMBER(cn9, &kp N9, &kp LS(N8)) // LSHIFT + N8 = (
CUSTOM_NUMBER(cn0, &kp N0, &kp LS(N9)) // LSHIFT + N9 = )
